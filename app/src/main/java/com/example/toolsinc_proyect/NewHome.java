    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTrabajadores.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NewHome.this, NewToolsHome.class);
        ...
        qrGeneratorButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || email.isEmpty() || phone.isEmpty() || address.isEmpty()) {
                    Toast.makeText(NewHome.this, "Por favor, ingrese todos los datos", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                try {
                    ...
                    String fileName = "qr_herramienta" + System.currentTimeMillis() + ".jpg";
                    ...
                    Toast.makeText(NewHome.this, "Imagen descargada en: " + file.getAbsolutePath(), Toast.LENGTH_LONG).show();
